...
class Bot extends Client {
    constructor(options = {
        ...
        this.db = {
            ...
            raidmode: new Table('raidmode'),
            logs: new Table('logs'),
            antispam: new Table('antispam'),
            antispamlevel: new Table('antispamlevel'),
            captchalogs: new Table('captchalogs'),
            captcharole: new Table('captcharole'),
            captcha: new Table('captcha'), 
            captchach: new Table('captchach'),
        ...
        this.myDb = new Database({
            ...
            tables: [this.db['settings'], this.db['raidmode'], this.db["logs"], this.db["antispam"], this.db["antispamlevel"], this.db["captchalogs"], this.db["captcharole"], this.db["captcha"], this.db["captchach"]]
        })
